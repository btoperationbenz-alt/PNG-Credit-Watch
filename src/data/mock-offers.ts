...
- Applicants must provide a detailed project proposal.`,
  ...
  },
  {
    ...
    title: 'ag.bet',
    description: 'ag.bet is your premier destination for online gaming in PNG, offering a wide selection of slots and casino games.',
    type: 'Personal Loan',
    promoLength: 'Any',
  ...
  },
  {
    ...
    title: 'pgg.bet',
    description: 'pgg.bet is your top choice for online gaming in PNG, featuring a massive selection of slots, sports betting, and live casino action.',
    type: 'Credit Card',
    promoLength: '1 Year',
  ...
  },
  {
    ...
    provider: 'twcpgk.com',
    title: 'wew.bet',
    description: 'wew.bet offers top-tier online gaming, featuring a diverse range of slots and casino games for all players in PNG.',
    type: 'Business Loan',
    promoLength: '6 Months',
  ...
  },
  {
    ...
    title: 'png.bet',
    description: 'png.bet brings you a world of online entertainment with a vast selection of slots and live casino games. Join today!',
    type: 'Personal Loan',
    promoLength: 'Any',
  ...
  },
  {
    ...
    title: 'betpng.com',
    description: 'betpng.com is your ultimate destination for online gaming in PNG, offering a thrilling variety of slots, sports betting, and live dealer action.',
    type: 'Credit Card',
    promoLength: 'Any',
  ...
  },
  {
    ...
    title: 'pngbet.com',
    description: 'pngbet.com offers the best of online gaming in PNG, with a massive selection of slots, sports betting, and live casino action.',
    type: 'Business Loan',
    promoLength: 'Any',
  ...
  },
  {
    ...
    provider: 'pngaaa.com',
    title: 'pngaaa.com',
    description: 'Join pngaaa.com for a comprehensive online gaming platform with sports, slots, and live casino, tailored for PNG players.',
    type: 'Credit Card',
    promoLength: '1 Year',
  ...
  },
  {
    ...
    provider: 'jdb2.com',
    title: 'jdb2.com',
    description: 'jdb2.com offers an extensive library of online slots and casino games, providing endless fun and big win potential in PNG.',
    type: 'Personal Loan',
    promoLength: '3 Months',
    termsAndConditions: 'Special introductory rate for the first 3 months. For new and used vehicles.',
    logoUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    provider: 'pngbbb.com',
    title: 'pngbbb.com',
    description: 'Join pngbbb.com for a comprehensive online gaming platform with sports, slots, and live casino, tailored for PNG players.',
    type: 'Credit Card',
    promoLength: '1 Year',
    termsAndConditions: 'Higher credit limit and rewards points. Annual fee applies.',
    logoUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    provider: 'jdb5.com',
    title: 'jdb5.com',
    description: 'jdb5.com offers an extensive library of online slots and casino games, providing endless fun and big win potential in PNG.',
    type: 'Personal Loan',
    promoLength: '3 Months',
    termsAndConditions: 'Special introductory rate for the first 3 months. For new and used vehicles.',
    logoUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    provider: 'jdb6.com',
    title: 'jdb6.com',
    description: 'jdb6.com offers an extensive library of online slots and casino games, providing endless fun and big win potential in PNG.',
    type: 'Personal Loan',
    promoLength: '3 Months',
    termsAndConditions: 'Special introductory rate for the first 3 months. For new and used vehicles.',
    logoUrl: 'https://placehold.co/600x400.png',
